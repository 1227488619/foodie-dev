...
public class ItemServiceImpl implements ItemService {
    ...
    public PagedGridResult searchItems(String keywords, String sort, Integer page, Integer pageSize) {
        ...
        PageHelper.startPage(page, pageSize);
        List<SearchItemsVO> searchItemsVOList = itemsMapper.searchItems(map);
    ...
    public PagedGridResult searchItems(Integer catId, String sort, Integer page, Integer pageSize) {
        ...
        PageHelper.startPage(page, pageSize);
        List<SearchItemsVO> searchItemsVOList = itemsMapper.searchItemsByThirdCat(map);
    ...
    // 查询 好 中 差 评数量的通用方法
    @Transactional(propagation = Propagation.SUPPORTS)
    Integer getCommentCounts(String itemId, Integer commentsLv){

        ItemsComments condition = new ItemsComments();
        condition.setItemId(itemId);
        if (commentsLv != null){
            condition.setCommentLevel(commentsLv);
        }
